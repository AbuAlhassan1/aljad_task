...
mixin _$RealEstate on _RealEstateBase, Store {
  late final _$isScrollLoadingAtom =
      Atom(name: '_RealEstateBase.isScrollLoading', context: context);

  @override
  bool get isScrollLoading {
    _$isScrollLoadingAtom.reportRead();
    return super.isScrollLoading;
  }

  @override
  set isScrollLoading(bool value) {
    _$isScrollLoadingAtom.reportWrite(value, super.isScrollLoading, () {
      super.isScrollLoading = value;
    });
  }
